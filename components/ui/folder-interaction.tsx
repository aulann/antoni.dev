...
export function FolderInteraction({ isOpen, onClick }: FolderInteractionProps) {
  return (
    <div className="flex justify-center items-center">
      <motion.div
        onClick={onClick}
        className="w-64 h-44 relative cursor-pointer"
        animate={!isOpen ? {
          rotate: [0, -2, 2, -2, 2, 0],
        } : { rotate: 0 }}
        transition={!isOpen ? {
      ...
      >
        ...
        <motion.div
          ...
          className="absolute -left-[1px] -right-[1px] -bottom-[1px] z-20 h-40 rounded-3xl origin-bottom flex justify-center items-center overflow-visible"
        >
          <svg
...
const Page = () => (
  <div className="w-full h-full bg-gradient-to-b from-[#E8E7F0] to-[#DCDAE8] rounded-xl shadow-lg p-3">
